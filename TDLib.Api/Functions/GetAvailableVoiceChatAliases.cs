namespace TdLib
{
    ...
    {
        /// <summary>Returns list of user and chat, which can be used as aliases to join a voice chat
        /// in the chat</summary>
        public static Task<MessageSenders> GetAvailableVoiceChatAliasesAsync(this Client client, long chatId = default)
        {
            return client.ExecuteAsync(new GetAvailableVoiceChatAliases { ChatId = chatId });
        }
