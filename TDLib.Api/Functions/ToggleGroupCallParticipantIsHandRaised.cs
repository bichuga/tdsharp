namespace TdLib
{
    ...
    {
        /// <summary>Toggles whether a group call participant hand is rased</summary>
        ...
        {
            return client.ExecuteAsync(new ToggleGroupCallParticipantIsHandRaised { GroupCallId = groupCallId, Participant = participant, IsHandRaised = isHandRaised });
        }
        ...
        public class ToggleGroupCallParticipantIsHandRaised : Function<Ok>
        {
            ...
            /// <summary>Pass true if the user's hand should be raised. Only self hand can be raised.
            /// Requires groupCall.can_be_managed group call flag to lower other's hand</summary>
            [JsonConverter(typeof(Converter))]
